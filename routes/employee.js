...
router.get('/timesheet/individual/week', timesheet_controller.employee_timesheet_individual_week);

// GET timesheet individual page for a month
router.get('/timesheet/individual/month', timesheet_controller.employee_timesheet_individual_month);
